 <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="index-2.html" class="logo">Alumnus- <span> System</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username"><?php echo $u_name; ?></span>
                            <b class="caret"></b>
                        </a>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                <!--  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="staffupload.php">Add Staff</a></li>
                          <li><a  href="stafftable.php">View Staff</a></li>
                     </ul>
                  </li>-->
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="stuupload.php">Add Record</a></li>
                          <li><a  href="stutable.php">View Record</a></li>
                      </ul>
                  </li>
				    <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                          <li><a  href="eventup.php">Add Up Coming Event</a></li>
				   ...
				   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="noticeup.php">Add Notice</a></li>
				...
				<!--   <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="stuupload.php">Test No.1</a></li>
                          <li><a  href="stutable.php">Test No.2</a></li>
						  <li><a  href="stuupload.php">Test No.3</a></li>
                      </ul>
                  </li>-->
